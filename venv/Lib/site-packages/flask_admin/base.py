...
class Admin(object):
    ...
    def __init__(self, app=None, name=None,
        ...
        """
            ...
            :param base_template:
                Override base HTML template for all static views. Defaults to `admin/admin_base_template.html`.
        """
        self.app = app
        ...
        self.base_template = base_template or 'admin/admin_base_template.html'
